...
// scenario (CLAUDE.md) where an upload can visibly take a while.
export function UploadProgressBanner({ progress }: { progress: number | null }) {
  ...
  return (
    <View style={styles.banner} pointerEvents="none">
      ...
      <Text style={styles.label}>アップロード中… {percent}%</Text>
    </View>
  );
}
